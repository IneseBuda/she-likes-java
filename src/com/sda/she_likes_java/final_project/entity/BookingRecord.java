...
public class BookingRecord {
    ...
    public BookingRecord(Long bookingId, User user, Car bookedCar, LocalDate startDate, LocalDate endDate, long priceInEurCents, boolean isPaid, PayingMethod payingMethod) {
