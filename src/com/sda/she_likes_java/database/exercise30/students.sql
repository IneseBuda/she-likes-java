...
ALTER TABLE STUDENTS ADD COLUMN GRADE INT NOT NULL;--WE ARE NOT PROVIDED INSIDE NOTHING,NO VALUE
ALTER TABLE STUDENTS ADD COLUMN GRADE INT NOT NULL USING 5;--ADDING GRADES FOR ALL COLUMNS
ALTER TABLE STUDENTS DROP COLUMN GRADE;-- DELETE COLUMN
--CHANGING ID COLUMN
